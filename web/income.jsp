...
<html>
    ...
    <body>
        ...
        <h1 class="heading" style="margin-top:9.5rem;">View<span>Income Report</span></h1>
        <section style="margin-top: -7rem;">

            <form action="ViewExpenseServlet" method="POST" id="income" class="add-product-form">
                ...
                <input type="submit" name="add_product" value="View Expense" class="btn" id="xyz" style="border: none;">
            </form>
        </section>
                ...
                <tbody>
                    <%
                        ...
                        if (loggedInUser != null) {
                            ...
                            List<Expense> expenseList = expenseDao.getAllIncomeByDateRange(fromDate, toDate, username,category);
                            int count = 1;
                    ...
                    <tr>
                        ...
                        <td><a href="DeleteExpenseServlet?id=<%= expense.getId() %>&from_date=<%= fromDate %>&to_date=<%= toDate %>&category=income">Delete</a></td>
